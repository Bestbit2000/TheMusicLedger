...
## 1. Metadata
- **Name:** Toggle switch (`.toggle-switch`, `.toggle-slider`, the rows it sits in: `.setting-row` (+ `.setting-row-grouped`), `.tuner-display-toggle-row`, `.flow-volta-toggle-row`, `.setting-field-pair`)
- **Category:** Inputs
- **Status:** Stable
